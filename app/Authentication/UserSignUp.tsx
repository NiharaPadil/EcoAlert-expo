...
//     router.push('./SignInMainPage'); // Use router to navigate
//   };
...
//       router.push('./SignInMainPage'); // Navigate to the sign-in page using router
//     } catch (error) {
...
//         {/* Image at the top */}
//         <Image source={require('../../assests/Images/SignupIcon.png')} style={styles.topImage} />
