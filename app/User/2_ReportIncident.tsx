...
//   const [photo, setPhoto] = useState<string | null>(null);
//   const [description, setDescription] = useState<string>('');
//   const [location, setLocation] = useState<string | null>(null); // Allow null for optional location
...
//             setUserData({ uid: user.uid, username: 'Anonymous', phonenumber: 'N/A' }); // Fallback data
//           }
//         }
//       } catch (error) {
...
//   const handleSubmit = async () => {
//     if (!photo || !description || !userData) {
//       Alert.alert('Error', 'Please provide all details: image, description, and user data.');
//       return;
//     }

//     const response = await fetch(photo);
//     const blob = await response.blob();
//     const storageRef = ref(storage, `incidents/${Date.now()}.jpg`);
...
//         assignedto: '',
//         description,
//         location: location || 'Location not provided', // Handle optional location
//         photourl: photoURL,
//         uid: userData.uid,
